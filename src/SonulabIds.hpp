...
inline constexpr wchar_t kSonulabDriverRegistryName[] = L"Sonulab StompPRO USB Driver";
inline constexpr wchar_t kSonulabDriverDescription[] = L"Sonulab StompPRO USB Driver";
